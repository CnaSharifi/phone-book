...
class ContactsTestCase(TestCase):
    ...
    # def test_secret_key_power(self):
    ...
    # def test_contacts_list_view_test_test(self):
    ...
    #     #obj = ContactModel.objects.create(name= 'farhad', number1= "0913727",user=user)
        
    #     import random
    #     st = time.time()
    #     #self.client.post('/contacts/', {'name': f'john{i}', 'number1': f"913{random.randint(111111,999999)}"})    
        
    #     response = self.client.get("/contacts/")
    #     et = time.time()
    #     contacts_list = response.context['list']
    #     print(contacts_list.count())
    #     print(contacts_list.get(id=500).name)
        
    #     #print('the result of time testing is :',et-st)
    #     #print(contacts_list) # this is the list of wines you included in the context
    #     self.assertEqual(contacts_list.count(),1000)
